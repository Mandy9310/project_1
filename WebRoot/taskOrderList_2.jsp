...
<html>
  ...
  <style type="text/css">
  	...
  	#list_1 li{width:120px;float:left;margin:0 0;text-align:center;}
  ...
  <body style="width:1050px;height:450px;">
	<div id="dataList_1" style="width:inherit;height:170px;margin:0 auto;overflow:auto;">
		<div id="list_1">	
			<c:forEach items="${requestScope.messages}" var="messages">
			<form id="form_1" action="servlet/Servlet_messageList?part=11" method="post">
				<ul id="ul_3">
					<c:choose>
					...
					<li>				
	    				<input type="text" class="input" name="number_order_task" value="${messages.getNumber_order_task()}" readonly="readonly">
	    			</li>	
					<li>				
	    				<input type="text" class="input" name="" value="${messages.getName_product()}" readonly="readonly">
	    			</li>			    			
					<li style="width:200px;">				
	    				<input type="text" class="input" name="" value="${messages.getType_product()}" readonly="readonly" style="width:200px;">
	    			</li>	
					<li>				
					...
					<li>				
   					...
   					<li style="">		    	
						<a href="servlet/Servlet_messageList?part=13&number_order_task=${messages.getNumber_order_task()}">
	...
	<c:choose>
		<c:when test="${sessionScope.number_order_task != null}">
		<div id="dataList_1" style="width:inherit;height:250px;margin:0 auto;">
			...
			<div style="width:inherit;">
				<iframe id="iframe" src="servlet/Servlet_messageList?part=14&number_order_task=${sessionScope.number_order_task }" style="width:inherit;height:210px;border:none;"></iframe>
			</div>	
		</div>		
		</c:when>
	</c:choose>	
